...
user.org:user:motor_steer_ctrl:1.0\
xilinx.com:ip:processing_system7:5.5\
digilentinc.com:ip:rgb2dvi:1.4\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:v_axi4s_vid_out:4.0\
user.org:user:videoprocessor:2.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set controls [ create_bd_port -dir O -from 7 -to 0 controls ]
  set debug [ create_bd_port -dir O -from 0 -to 0 debug ]
  ...
  set pwm_motor1 [ create_bd_port -dir O pwm_motor1 ]
  set pwm_motor2 [ create_bd_port -dir O pwm_motor2 ]
  set pwm_steer [ create_bd_port -dir O pwm_steer ]
  ...
  set vid_field_id [ create_bd_port -dir O vid_field_id ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#gpio[47]#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins ps7_0_axi_periph/M06_AXI] [get_bd_intf_pins videoprocessor_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins motor_steer_ctrl_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  ...
  connect_bd_net -net PixelClk_Generator_clk_out1 [get_bd_pins DVIClocking_0/PixelClk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins rst_vid_clk_dyn/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins videoprocessor_0/PixelClk] [get_bd_pins vtg/clk]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports debug] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports controls] [get_bd_pins axi_gpio_1/gpio_io_o]
  ...
  connect_bd_net -net motor_steer_ctrl_0_pwm_motor [get_bd_ports pwm_motor1] [get_bd_ports pwm_motor2] [get_bd_pins motor_steer_ctrl_0/pwm_motor]
  connect_bd_net -net motor_steer_ctrl_0_pwm_steer [get_bd_ports pwm_steer] [get_bd_pins motor_steer_ctrl_0/pwm_steer]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins AXI_BayerToRGB_1/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_0/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_0/sStreamReset_n] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins motor_steer_ctrl_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins video_dynclk/s_axi_aresetn] [get_bd_pins videoprocessor_0/s00_axi_aresetn] [get_bd_pins vtg/s_axi_aresetn]
  ...
  connect_bd_net -net s_axil_clk_50 [get_bd_pins AXI_GammaCorrection_0/AxiLiteClk] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins motor_steer_ctrl_0/s00_axi_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk] [get_bd_pins video_dynclk/s_axi_aclk] [get_bd_pins videoprocessor_0/s00_axi_aclk] [get_bd_pins vtg/s_axi_aclk]
  connect_bd_net -net sel_1 [get_bd_ports sel] [get_bd_pins videoprocessor_0/sel]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_axi4s_vid_out_0/locked]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins v_axi4s_vid_out_0/vid_active_video] [get_bd_pins videoprocessor_0/vid_active_video_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins videoprocessor_0/vid_data_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_field_id [get_bd_ports vid_field_id] [get_bd_pins v_axi4s_vid_out_0/vid_field_id] [get_bd_pins videoprocessor_0/vid_field_id_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hblank [get_bd_ports vid_hblank] [get_bd_pins v_axi4s_vid_out_0/vid_hblank] [get_bd_pins videoprocessor_0/vid_hblank_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins v_axi4s_vid_out_0/vid_hsync] [get_bd_pins videoprocessor_0/vid_hsync_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vblank [get_bd_ports vid_vblank] [get_bd_pins v_axi4s_vid_out_0/vid_vblank] [get_bd_pins videoprocessor_0/vid_vblank_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins v_axi4s_vid_out_0/vid_vsync] [get_bd_pins videoprocessor_0/vid_vsync_in]
  ...
  connect_bd_net -net videoprocessor_0_done [get_bd_ports done] [get_bd_pins videoprocessor_0/done]
  connect_bd_net -net videoprocessor_0_test [get_bd_ports test] [get_bd_pins videoprocessor_0/test]
  connect_bd_net -net videoprocessor_0_vid_active_video_out [get_bd_ports vid_active_video] [get_bd_pins rgb2dvi_0/vid_pVDE] [get_bd_pins videoprocessor_0/vid_active_video_out]
  connect_bd_net -net videoprocessor_0_vid_data_out [get_bd_pins rgb2dvi_0/vid_pData] [get_bd_pins videoprocessor_0/vid_data_out]
  connect_bd_net -net videoprocessor_0_vid_hsync_out [get_bd_ports vid_hsync] [get_bd_pins rgb2dvi_0/vid_pHSync] [get_bd_pins videoprocessor_0/vid_hsync_out]
  connect_bd_net -net videoprocessor_0_vid_vsync_out [get_bd_ports vid_vsync] [get_bd_pins rgb2dvi_0/vid_pVSync] [get_bd_pins videoprocessor_0/vid_vsync_out]
  ...
  assign_bd_address -offset 0x43C60000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs motor_steer_ctrl_0/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x43C50000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs videoprocessor_0/S00_AXI/S00_AXI_reg] -force
