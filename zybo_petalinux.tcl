...
#
# zybo_petalinux.tcl: Tcl script for re-creating project 'zybo_petalinux'
#
# Generated by Vivado on Thu Mar 24 20:17:21 EDT 2022
...
#
# 1. This project restoration tcl script (zybo_petalinux.tcl) that was generated.
#
...
set _xil_proj_name_ "zybo_petalinux"
...
set script_file "zybo_petalinux.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/zybo_petalinux_z720"]"
...
set_property -name "top" -value "zynq_petalinux_wrapper" -objects $obj
...
# Proc to create BD zynq_petalinux
proc cr_bd_zynq_petalinux { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zynq_petalinux
...
# End of cr_bd_zynq_petalinux()
cr_bd_zynq_petalinux ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files zynq_petalinux.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files zynq_petalinux.bd ] 
set_property IS_ENABLED "1" [get_files zynq_petalinux.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files zynq_petalinux.bd ] 
set_property IS_LOCKED "0" [get_files zynq_petalinux.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files zynq_petalinux.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files zynq_petalinux.bd ] 
set_property PFM_NAME "" [get_files zynq_petalinux.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files zynq_petalinux.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynq_petalinux.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files zynq_petalinux.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files zynq_petalinux.bd ] 
set_property USED_IN_SIMULATION "1" [get_files zynq_petalinux.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files zynq_petalinux.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse zynq_petalinux.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zybo_petalinux_z720/zybo_petalinux.gen/sources_1/bd/zynq_petalinux/hdl/zynq_petalinux_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse zynq_petalinux.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "/home/dingus/zybo_petalinux/zybo_petalinux.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/dingus/zybo_petalinux/zybo_petalinux.srcs/utils_1/imports/impl_1" -objects $obj
